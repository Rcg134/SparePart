                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="card-box table-responsive">
                                             ...
                                             <thead>           	
                                                        <tr> 
                                                                  <th style="border-bottom: none;" class="textdisplay text-center" hidden></th>
                                                                  <th style="border-bottom: none;" class="textdisplay text-center"></th>
                                                                  <th  style="border-bottom: none;" class="textdisplay text-center"></th>
                                                                  <th  style="border-bottom: none;" class="textdisplay text-center"></th>
                                                                  <th  style="border-bottom: none;" class="textdisplay text-center"></th>
                                                                  <th  style="border-bottom: none;" class="textdisplay text-center"></th>
                                                                  <th  style="border-bottom: none;" class="textdisplay text-center"></th>
                                                                  <th  style="border-bottom: none;" class="textdisplay text-center"></th>
                                                                  <th  style="border-bottom: none;" colspan="4" class="textdisplay text-center">Location</th>
                                                           	...
                                                           	<tr> 
                                                                  ...
                                                                  <th style="border-top: none;" class="textdisplay text-center">BU</th>
                                                                  <th style="border-top: none;" class="textdisplay text-center">PKG</th>
                                                                  <th style="border-top: none;" class="textdisplay text-center">DESCRIPTION</th>
                                                                  <th style="border-top: none;" class="textdisplay text-center">DRAW PART NUMBER</th>
                                                                  <th style="border-top: none;" class="textdisplay text-center">SID#</th>
                                                                  <th style="border-top: none;" class="textdisplay text-center">PART NUMBER</th>
                                                                  <th  class="textdisplay text-center">Rack</th>
                                                                  <th  class="textdisplay text-center">Level</th>
                                                                  <th  class="textdisplay text-center">Column</th>
                                                                  <th  class="textdisplay text-center">Row</th>                                                         
            ...
            <div class="modal-body" id='SpareDetails'>
                ...
                <form class="needs-validation" id="lineDetails" method="post" enctype="multipart/form-data" novalidate>
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <B>
                                ...
                                <input class="form-control" id="BU" required="required">
                        </div>
                        ...
                        <div class="col-md-4">
                            <B>
                                ...
                                <input class="form-control" id="PKG" required="required">
                        </div>
                        ...
                        <div class="col-md-4">                   
                          ...
                          <input class="form-control" id="DESCR" required="required">
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <B>
                                <label class="control-label">DRAW PART NUMBER: </label>
                            </B>
                          <input class="form-control" id="DRAWPART" required="required">
                        </div>
                        ...
                        <div class="col-md-4">
						  ...
						  <input class="form-control" id="SID" required="required">
                        </div>
                      ...
                      <div class="col-md-4">
                            <B>
                                ...
                                <input class="form-control" id="Rock" required="required">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                          ...
                          <input class="form-control" id="Level" required="required">
                        </div>
                        ...
                        <div class="col-md-4">
						  ...
						  <input class="form-control" id="Icolumn" required="required">
                        </div>
                      ...
                      <div class="col-md-4">
                            <B>
                                ...
                                <input class="form-control" id="Irow" required="required">
                        </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                            <B>
                                ...
                                <input class="form-control" id="PN" required="required">
                        </div>
                    </div>
             ...
             <BR/>
 				  ...
 				  <div class="col-lg-12  bg-white rounded-top tab-head">
 				      <ul class="nav nav-tabs" id="myTab" role="tablist">
                           ...
                           <li class="nav-item">
 				              <a class="nav-link" id="imageqr-tab" data-toggle="tab" href="#imageqr" role="tab" aria-controls="imageqr" aria-selected="true">QR Image</a>
 				          </li>
 				      </ul>
 				  </div>
